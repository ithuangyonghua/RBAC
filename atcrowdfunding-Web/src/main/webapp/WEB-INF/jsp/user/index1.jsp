 ...
 <hr style="clear:both;">
          <div class="table-responsive">
            <table class="table  table-bordered">
              ...
              <tbody>
              <c:forEach items="${userList}" varStatus="index" var="i">
                <tr>
                  <td>${index.count}</td>
			     ...
			     <tr >
				     <td colspan="6" align="center">
						<ul class="pagination">
								...
								<c:forEach begin="1" end="${totalno}" varStatus="index">
								  <c:if test="${pageno == index.count}">
								    <li class="active"><a href="#" >${index.count}</a></li>
								  </c:if>
								  <c:if test="${pageno != index.count}">
								    <li><a href="#" onclick="changePageno(${index.count})">${index.count}</a></li>
								  </c:if>
								</c:forEach>
